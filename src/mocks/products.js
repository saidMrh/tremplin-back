export const products = [
  {
    id: 0,
    product: "Encore une belle victoire pour la Team TREMPLIN au Challenge du Monde des Grandes Ecoles et des Universités",
    link: "ui8.net/product/product-link",
    image: "/images/content/la-team.jpg",
  ...
  {
    id: 1,
    product: "Conférence TREMPLIN au Challenge du Monde des Grandes Ecoles et des Universités",
    link: "ui8.net/product/product-link",
    image: "/images/content/conference.jpg",
  ...
  {
    id: 2,
    product: "5 conseils pour trouver le meilleur job",
    link: "ui8.net/product/product-link",
  ...
  {
    id: 3,
    product: "Présentez vous en 5 mins",
    link: "ui8.net/product/product-link",
